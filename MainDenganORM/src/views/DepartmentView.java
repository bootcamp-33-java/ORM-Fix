...
//        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for (int i = 0; i < departments.size(); i++) {
            ...
            row[0] = count + 1;
            row[1] = departments.get(count).getDepartmentId();
            row[2] = departments.get(count).getDepartmentName();
            row[3] = departments.get(count).getManagerId();
            row[4] = departments.get(count).getLocationId();
            model.addRow(row);
            count = count + 1;
        }
